 ...
 */
export async function updatePriceFeeds(hermesClient, pythContract, feeds, priceDeviationBps, maxStalenessSec, dryRun = false) {
    ...
    const updateData = updates.binary.data.map((d) => d.startsWith("0x") ? d : `0x${d}`);
